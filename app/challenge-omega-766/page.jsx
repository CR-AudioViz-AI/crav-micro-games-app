    ...
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        ...
        <div className="border rounded-lg p-4 space-y-4">
          <Engine type="pathfind" gameId="challenge-omega-766" title="Omega Challenge" />
        </div>
        <PaywallGate featureId="CHALLENGE-OMEGA-766" mode="premium" />
        <AdSlot id="mid" />
      </div>
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="challenge-omega-766" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
