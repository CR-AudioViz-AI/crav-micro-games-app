  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Zoom ID Expert</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="zoom-id" mode="reflex" title="Zoom ID Expert" />
        </div>
        <PaywallGate featureId="ZOOM_ID_EXPERT">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Zoom ID Expert — Pro/Elite</div>
