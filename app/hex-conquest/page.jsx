  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Hex Conquest</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="hex-conquest" mode="reflex" title="Hex Conquest" />
        </div>
        <PaywallGate featureId="HEX_CONQUEST">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Hex Conquest — Pro/Elite</div>
      ...
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="hex-conquest" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
