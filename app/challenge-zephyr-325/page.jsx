  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Zephyr Challenge</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <Engine type="reflex" gameId="challenge-zephyr-325" title="Zephyr Challenge" />
        </div>
        <PaywallGate featureId="CHALLENGE-ZEPHYR-325" mode="premium" />
        <AdSlot id="mid" />
      </div>
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="challenge-zephyr-325" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
