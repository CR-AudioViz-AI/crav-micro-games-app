  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Flag Forge</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="flag-forge" mode="anagram" title="Flag Forge" />
        </div>
        <PaywallGate featureId="FLAG_FORGE">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Flag Forge — Pro/Elite</div>
