  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Nano Colony</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="nano-colony" mode="reflex" title="Nano Colony" />
        </div>
        <PaywallGate featureId="NANO_COLONY">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Nano Colony — Pro/Elite</div>
      ...
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="nano-colony" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
