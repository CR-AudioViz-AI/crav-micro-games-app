    ...
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        ...
        <div className="border rounded-lg p-4 space-y-4">
          <Engine type="pathfind" gameId="challenge-kernel-580" title="Kernel Challenge" />
        </div>
        <PaywallGate featureId="CHALLENGE-KERNEL-580" mode="premium" />
        <AdSlot id="mid" />
      </div>
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="challenge-kernel-580" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
