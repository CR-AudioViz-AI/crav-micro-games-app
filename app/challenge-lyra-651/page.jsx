    ...
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        ...
        <div className="border rounded-lg p-4 space-y-4">
          <Engine type="stacker" gameId="challenge-lyra-651" title="Lyra Challenge" />
        </div>
        <PaywallGate featureId="CHALLENGE-LYRA-651" mode="premium" />
        <AdSlot id="mid" />
      </div>
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="challenge-lyra-651" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
