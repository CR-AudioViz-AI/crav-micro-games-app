  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Quote Cipher</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="quote-cipher" mode="anagram" title="Quote Cipher" />
        </div>
        <PaywallGate featureId="QUOTE_CIPHER">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Quote Cipher — Pro/Elite</div>
      ...
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="quote-cipher" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
