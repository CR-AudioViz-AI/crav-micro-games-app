  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Orbital Catch</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="orbital-catch" mode="reflex" title="Orbital Catch" />
        </div>
        <PaywallGate featureId="ORBITAL_CATCH">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Orbital Catch — Pro/Elite</div>
      ...
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="orbital-catch" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
