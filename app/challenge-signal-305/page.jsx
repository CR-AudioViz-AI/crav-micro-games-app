  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Signal Challenge</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <Engine type="tileslide" gameId="challenge-signal-305" title="Signal Challenge" />
        </div>
        <PaywallGate featureId="CHALLENGE-SIGNAL-305" mode="premium" />
        <AdSlot id="mid" />
      </div>
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="challenge-signal-305" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
