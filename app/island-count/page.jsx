  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Island Count</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="island-count" mode="reflex" title="Island Count" />
        </div>
        <PaywallGate featureId="ISLAND_COUNT">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Island Count — Pro/Elite</div>
      ...
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="island-count" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
