  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Bluff & Tell</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="bluff-tell" mode="anagram" title="Bluff & Tell" />
        </div>
        <PaywallGate featureId="BLUFF_TELL">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Bluff & Tell — Pro/Elite</div>
