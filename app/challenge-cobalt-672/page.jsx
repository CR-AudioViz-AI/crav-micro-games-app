    ...
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        ...
        <div className="border rounded-lg p-4 space-y-4">
          <Engine type="memory" gameId="challenge-cobalt-672" title="Cobalt Challenge" />
        </div>
        <PaywallGate featureId="CHALLENGE-COBALT-672" mode="premium" />
        <AdSlot id="mid" />
      </div>
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="challenge-cobalt-672" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
