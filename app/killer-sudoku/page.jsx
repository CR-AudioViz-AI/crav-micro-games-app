  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Killer Sudoku Mini</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="killer-sudoku" mode="reflex" title="Killer Sudoku Mini" />
        </div>
        <PaywallGate featureId="KILLER_SUDOKU">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Killer Sudoku Mini — Pro/Elite</div>
      ...
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="killer-sudoku" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
