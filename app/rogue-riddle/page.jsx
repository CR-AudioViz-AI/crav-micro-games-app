  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Rogue Riddle</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="rogue-riddle" mode="anagram" title="Rogue Riddle" />
        </div>
        <PaywallGate featureId="ROGUE_RIDDLE">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Rogue Riddle — Pro/Elite</div>
      ...
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="rogue-riddle" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
