    ...
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        ...
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="stacksmith" mode="reflex" title="Stacksmith" />
        </div>
        <PaywallGate featureId="STACKSMITH">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Stacksmith — Pro/Elite</div>
