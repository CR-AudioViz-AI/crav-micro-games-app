  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Sound Match Pro</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="sound-match" mode="reflex" title="Sound Match Pro" />
        </div>
        <PaywallGate featureId="SOUND_MATCH_PRO">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Sound Match Pro — Pro/Elite</div>
      ...
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="sound-match" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
