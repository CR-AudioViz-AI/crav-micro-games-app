    ...
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        ...
        <div className="border rounded-lg p-4 space-y-4">
          <Engine type="tileslide" gameId="challenge-onyx-653" title="Onyx Challenge" />
        </div>
        <PaywallGate featureId="CHALLENGE-ONYX-653" mode="premium" />
        <AdSlot id="mid" />
      </div>
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="challenge-onyx-653" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
