    ...
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        ...
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="river-crossing" mode="reflex" title="River Crossing+" />
        </div>
        <PaywallGate featureId="RIVER_CROSSING">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">River Crossing+ — Pro/Elite</div>
      ...
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="river-crossing" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
