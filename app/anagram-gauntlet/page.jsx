  ...
  return (
    <div className="max-w-6xl mx-auto p-6 grid md:grid-cols-12 gap-6">
      <div className="md:col-span-8 space-y-4">
        <h1 className="text-3xl font-bold">Master Anagram Gauntlet</h1>
        <AdSlot id="top" />
        <div className="border rounded-lg p-4 space-y-4">
          <ChallengeEngine gameId="anagram-gauntlet" mode="anagram" title="Master Anagram Gauntlet" />
        </div>
        <PaywallGate featureId="ANAGRAM_GAUNTLET">
          <div className="border rounded-lg p-4">
            <div className="font-semibold mb-2">Master Anagram Gauntlet — Pro/Elite</div>
      ...
      <div className="md:col-span-4 space-y-4">
        <Leaderboard gameId="anagram-gauntlet" />
        <UpsellSidebar />
        <AdSlot id="side" />
      </div>
    </div>
